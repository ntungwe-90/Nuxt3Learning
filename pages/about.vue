...
<template>
 <div class="py-20 bg-cover bg-no-repeat bg-fixed" style="background-image: url(https://media.vanityfair.com/photos/5ce426151c0b0773cacd1121/master/pass/star-wars-feature-vf-2019-summer-embed-05.jpg)">
    <div class="container m-auto text-center px-6 opacity-100">
      ...
      <button class="bg-white font-bold rounded-full py-4 px-8 shadow-lg uppercase tracking-wider hover:border-transparent hover:text-blue-500 hover:bg-gray-800 transition-all">Commander Skywalker, do you copy?</button>
    </div>
  </div>
        ...
        <section class="container mx-auto px-6 p-10">
          ...
          <div class="flex items-center flex-wrap mb-20">
            ...
            <div class="w-full md:w-1/2">
              <img class="rounded-lg" src="../public/images/arturo-rey-5yP83RhaFGA-unsplash.jpg" alt="Vortex" />
            </div>
          </div>
          <div class="flex items-center flex-wrap mb-20">
            <div class="w-full md:w-1/2">
              <img class="rounded-lg" src="../public/images/burgess-milner-OYYE4g-I5ZQ-unsplash.jpg" alt="use the force" />
            </div>
          ...
          <div class="flex items-center flex-wrap mb-20">
            ...
            <div class="w-full md:w-1/2">
              <img class="rounded-lg" src="../public/images/suheyl-burak-p7I07kuPSyU-unsplash.jpg" alt="Syncing" />
            </div>
          </div>
        </section>
